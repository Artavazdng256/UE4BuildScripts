...
If EXIST  "C:\%PROJECT_NAME%_Server"  rmdir C:\%PROJECT_NAME%_Server /s /q
IF EXIST  "C:\%PROJECT_NAME%_Client"  rmdir C:\%PROJECT_NAME%_Client /s /q
IF EXIST  "C:\%PROJECT_NAME%Archive"  rmdir C:\%PROJECT_NAME%Archive /s /q

set PROJECT_PATH=%CD%\%PROJECT_NAME%.uproject

set CLIENTCONFIG=Development

set ARCHIVEDIRECTORY=C:\%PROJECT_NAME%_Server
set ARCHIVEDIRECTORY_CLIENT=C:\%PROJECT_NAME%_Client\WindowsNoEditor

set SERVER_PATH=%ARCHIVEDIRECTORY%\WindowsNoEditor

set FINAL_SERVER_PATH=%ARCHIVEDIRECTORY%\%PROJECT_NAME%DedicatedServer
